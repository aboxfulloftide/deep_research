            ...
            if payload.get("collection_only"):
                ...
                return {
                    ...
                    "research_plan": {
                        ...
                        "facets": [{"id": facet.id, "question": facet.question, "search_query": facet.search_query, "purpose": facet.purpose, "capabilities": facet.capabilities} for facet in research_bundle.plan.facets],
                    },
