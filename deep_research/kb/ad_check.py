...
Classifies from the claim's own text only, same one-call-per-claim shape as
trust.py's source classifier, and shares its risk posture: a false "is_ad"
...
async def classify_claim_is_ad(llm: LLMClient, claim_text: str) -> dict:
    messages = [
